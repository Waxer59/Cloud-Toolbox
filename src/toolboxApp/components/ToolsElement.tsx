...
const ToolsElement: React.FC<Props> = ({ name, icon, path }) => {
  return (
    <li className="sm:p-[5px] p-[15px] w-[65%] sm:w-full border border-solid border-neutral-400 rounded shadow-xl w-full max-w-[800px] flex items-center justify-center flex-col gap-[5px] sm:gap-0 sm:flex-row">
      <Link
